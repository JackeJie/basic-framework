package com.example.framework.common.response;
...
public class ApiResult<T> implements Serializable {
    ...
    public static <T> ApiResult<T> result(ApiCode apiCode, String message, T data) {
        ...
        if (StringUtils.isNotBlank(apiMessage) && !StringUtils.isNotBlank(message)) {
            message = apiMessage;
        }
    ...
    public static ApiResult fail(boolean flag) {
